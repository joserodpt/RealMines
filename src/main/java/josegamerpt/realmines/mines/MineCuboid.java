...
public class MineCuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
	 ...
	 */
	public MineCuboid(Location l1, Location l2) {
	 ...
	 */
	public MineCuboid(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
	 ...
	 * @param z2        - Z co-ordinate of corner 2
	 */
	private MineCuboid(String worldName, int x1, int y1, int z1, int x2, int y2, int z2) {
	 ...
	 */
	public MineCuboid(Map<String, Object> map) {
	 ...
	 */
	public MineCuboid expand(CuboidDirection dir, int amount) {
		switch (dir) {
		case North:
	 ...
	 */
	public MineCuboid shift(CuboidDirection dir, int amount) {
	 ...
	 */
	public MineCuboid outset(CuboidDirection dir, int amount) {
		MineCuboid c;
		switch (dir) {
		case Horizontal:
	 ...
	 */
	public MineCuboid inset(CuboidDirection dir, int amount) {
	 ...
	 */
	public MineCuboid contract(CuboidDirection dir) {
		MineCuboid face = getFace(dir.opposite());
		switch (dir) {
		case Down:
	 ...
	 */
	public MineCuboid getFace(CuboidDirection dir) {
		switch (dir) {
		case Down:
	 ...
	 */
	public MineCuboid getBoundingCuboid(MineCuboid other) {
		if (other == null)
			return this;
