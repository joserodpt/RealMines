 ...
 */
public class MineCuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
     ...
     */
    public MineCuboid(final Location l1, final Location l2) {
     ...
     */
    public MineCuboid(final Location l1) {
        this(l1, l1);
        this.totalBlocks = this.getVolume();
     ...
     * @param z2        - Z co-ordinate of corner 2
     */
    private MineCuboid(final String worldName, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2) {
     ...
     */
    public MineCuboid(final Map<String, Object> map) {
     ...
     */
    public MineCuboid expand(final CuboidDirection dir, final int amount) {
        switch (dir) {
            case North:
                return new MineCuboid(this.worldName, this.x1 - amount, this.y1, this.z1, this.x2, this.y2, this.z2);
            case South:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2 + amount, this.y2, this.z2);
            case East:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1 - amount, this.x2, this.y2, this.z2);
            case West:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2 + amount);
            case Down:
                return new MineCuboid(this.worldName, this.x1, this.y1 - amount, this.z1, this.x2, this.y2, this.z2);
            case Up:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2 + amount, this.z2);
            default:
     ...
     */
    public MineCuboid shift(final CuboidDirection dir, final int amount) {
     ...
     */
    public MineCuboid outset(final CuboidDirection dir, final int amount) {
        final MineCuboid c;
        switch (dir) {
            case Horizontal:
     ...
     */
    public MineCuboid inset(final CuboidDirection dir, final int amount) {
     ...
     */
    public MineCuboid contract(final CuboidDirection dir) {
        MineCuboid face = this.getFace(dir.opposite());
        switch (dir) {
            case Down:
                while (face.containsOnly(Material.AIR) && face.getLowerY() > this.getLowerY()) {
                    face = face.shift(CuboidDirection.Down, 1);
                }
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, face.getUpperY(), this.z2);
            case Up:
                while (face.containsOnly(Material.AIR) && face.getUpperY() < this.getUpperY()) {
                    face = face.shift(CuboidDirection.Up, 1);
                }
                return new MineCuboid(this.worldName, this.x1, face.getLowerY(), this.z1, this.x2, this.y2, this.z2);
            case North:
                while (face.containsOnly(Material.AIR) && face.getLowerX() > this.getLowerX()) {
                    face = face.shift(CuboidDirection.North, 1);
                }
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, face.getUpperX(), this.y2, this.z2);
            case South:
                while (face.containsOnly(Material.AIR) && face.getUpperX() < this.getUpperX()) {
                    face = face.shift(CuboidDirection.South, 1);
                }
                return new MineCuboid(this.worldName, face.getLowerX(), this.y1, this.z1, this.x2, this.y2, this.z2);
            case East:
                while (face.containsOnly(Material.AIR) && face.getLowerZ() > this.getLowerZ()) {
                    face = face.shift(CuboidDirection.East, 1);
                }
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, face.getUpperZ());
            case West:
                while (face.containsOnly(Material.AIR) && face.getUpperZ() < this.getUpperZ()) {
                    face = face.shift(CuboidDirection.West, 1);
                }
                return new MineCuboid(this.worldName, this.x1, this.y1, face.getLowerZ(), this.x2, this.y2, this.z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
     ...
     */
    public MineCuboid getFace(final CuboidDirection dir) {
        switch (dir) {
            case Down:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y1, this.z2);
            case Up:
                return new MineCuboid(this.worldName, this.x1, this.y2, this.z1, this.x2, this.y2, this.z2);
            case North:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x1, this.y2, this.z2);
            case South:
                return new MineCuboid(this.worldName, this.x2, this.y1, this.z1, this.x2, this.y2, this.z2);
            case East:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, this.z1);
            case West:
                return new MineCuboid(this.worldName, this.x1, this.y1, this.z2, this.x2, this.y2, this.z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
     ...
     */
    public MineCuboid getBoundingCuboid(final MineCuboid other) {
        if (other == null)
            return this;
        ...
        return new MineCuboid(this.worldName, xMin, yMin, zMin, xMax, yMax, zMax);
    }
    ...
    @Override
    public MineCuboid clone() {
        return new MineCuboid(this);
    }
